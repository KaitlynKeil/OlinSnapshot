...
function createGraph() {
  ...
  d3.json("/data", function(error, quotes) {
    // Can this list of categories come from the server? This would make the
    // code less fragile, by reducing the number of places that need to be
    // edited if the list is edited.
    var input_data = {
      name: "Categories",
      value: 60,
      children: [
...
// Unused code should generally be removed instead of commented out. If it's
// left, add a comment explaining under what conditions it should be added back.
...
function updateData(selected_category) {
  ...
  // See the comment above about deriving the list of categories from the data.
